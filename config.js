...
const banmsgtype = 'Olá @${event.who.replace('@c.us', '')}, números fake não são permitidos nesse grupo, se você não for alguém mal e quiser estar no grupo pacificamente, por favor contate os administradores :)'
